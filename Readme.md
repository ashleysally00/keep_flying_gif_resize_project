...
I created a flying butterfly gif using frame-by-frame animation techniques in Photoshop and Procreate. Then I decided I wanted to analyze the butterfly gif and try to resize it using Python. 
